  ...
  >
    ...
    <div class="flex flex-wrap items-center p-1">
      <div
        ...
        :key="item"
        class="flex p-1 mb-1 mr-1 text-xs rounded-md bg-melon text-davys"
      >
        <span>{{ item }}</span>
      ...
      <input
        ...
        class="w-full p-1 font-mono text-sm font-bold rounded-md outline-none appearance-none text-melon bg-davys"
      />
    </div>
  </div>
</template>
